...
本轮将竞赛提交命名副本入库：[我们爱数学建模.pdf](提交/我们爱数学建模.pdf) 与 [支撑材料.zip](提交/支撑材料.zip)。二者分别与[四问论文初稿](paper/q1234_draft_v1/四问论文初稿_v1.pdf)、[A题_支撑材料.zip](q1234_submission_support_20260913/out/A题_支撑材料.zip) 逐字节一致；哈希与对应关系见[提交目录说明](提交/README.md)。本轮不改模型、数值或论文正文。
...
- [竞赛提交命名副本](提交/README.md)：[我们爱数学建模.pdf](提交/我们爱数学建模.pdf)与[支撑材料.zip](提交/支撑材料.zip)。
